...
<html>     
    ...
    <body background="Imagenes/fondo3.jpg"> 
        ...
        <br>        
            ...
            <tr> 
            <h5 align="center" >Citas con los siguientes pacientes</h5>
                <th>ID</th>
                <th>Nombre</th>            
                <th>Sexo</th>            
                <th>Nacimiento</th>            
...
<%           for (CitaMedico cita : citas) {%>          
    ...
    <form action="doctor" method="POST">
            <h2>Selecciona el Id del paciente que va atender</h2>
            <table>
                <input readonly type="text"  value='<%=cuentaI%>' Id="user" name="user" >
                <tr>
                <td>ID paciente:</td>                                  
                <td><select align="center" required type="text" Id='paciente' name="paciente" >
                    <%
                        for (CitaMedico cita : citas) {%>
                    <option><%=cita.getCodigo()%></option>
                    <% }%>
                    </select></td>
                </tr>
            </table> 
        <input align="center" type="submit" name="boton" value="Atender paciente">
    </form>
                    
    </body>
    <%@ include file = "../pagesDoctor/llenaRegistroInforme.jsp" %>
</html> 
